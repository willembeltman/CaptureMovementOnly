...
{
    public WaitThenReadFrameThenTickFps(WaitForNextDateTimeHelper waitTillNextTime, ScreenshotCapturer reader, FpsCounter inputFps)
    {
    ...
    public WaitForNextDateTimeHelper WaitTillNextTime { get; }
