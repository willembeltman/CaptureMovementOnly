...
{
    private readonly DirectoryInfo FFProbeDirectory = FFProbeDirectory ?? new DirectoryInfo(Environment.CurrentDirectory);
    ...
    protected FFProbeRapport? FFProbeRapport
    {
        get
        {
